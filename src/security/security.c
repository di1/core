...
security_get_analysis (struct security *sec, char **json)
{
...
enum RISKI_ERROR_CODE
security_get_hash (struct security *s, size_t *hash)
{
...
enum RISKI_ERROR_CODE
security_hash (char *name, size_t *index)
{
...
enum RISKI_ERROR_CODE
security_get_chart (struct security *sec, char **json)
{
  PTR_CHECK (sec, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
  PTR_CHECK (json, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
...
enum RISKI_ERROR_CODE
security_get_latest_candle (struct security *sec, char **json)
{
  PTR_CHECK (sec, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
  PTR_CHECK (json, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
...
enum RISKI_ERROR_CODE
security_cmp (char *n1, struct security *s, bool *res)
{
...
enum RISKI_ERROR_CODE
security_new (char *name, uint64_t interval, struct security **sec)
{
  PTR_CHECK (name, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
  PTR_CHECK (sec, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);

  struct security *sec_
      = (struct security *)malloc (1 * sizeof (struct security));
...
enum RISKI_ERROR_CODE
security_book_update (struct security *sec, bool side, int64_t price,
                      int64_t quantity)
{
  PTR_CHECK (sec, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
...
enum RISKI_ERROR_CODE
security_chart_update (struct security *sec, int64_t price, uint64_t ts)
{
  PTR_CHECK (sec, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
