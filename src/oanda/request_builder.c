...
oanda_v20_v3_accounts (char *host, char *api_key, char **res)
{
...
enum RISKI_ERROR_CODE
oanda_v20_v3_accounts_instruments (char *host, char *api_key, char **res,
                                   char *account_id)
{
  PTR_CHECK (res, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
...
enum RISKI_ERROR_CODE
oanda_v20_v3_accounts_pricing (char *host, char *api_key,
                               char **instrument_name, size_t num_instruments,
                               char *account_id, char **res)
{
  PTR_CHECK (res, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
  PTR_CHECK (account_id, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
