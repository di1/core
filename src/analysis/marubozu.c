...
enum RISKI_ERROR_CODE is_white_marubozu(struct candle* cnd, enum SINGLE_CANDLE_PATTERNS* res) {
...
enum RISKI_ERROR_CODE is_black_marubozu(struct candle* cnd, enum SINGLE_CANDLE_PATTERNS* res) {
  PTR_CHECK(cnd, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
  PTR_CHECK(res, RISKI_ERROR_CODE_NULL_PTR, RISKI_ERROR_TEXT);
