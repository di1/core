...
candle_new (int64_t price, uint64_t time, struct candle **cnd)
{
...
enum RISKI_ERROR_CODE
candle_update (struct candle *c, int64_t price, uint64_t time)
{
...
enum RISKI_ERROR_CODE
candle_json (struct candle *c, char **json)
{
  /**
   * {
   *  "candle" : {
