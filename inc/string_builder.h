...
const char* STRING_BUILDER_ERROR_STR[4] = {
  "STRING_BUILDER_NO_ERROR",
  "STRING_BUILDER_MALLOC_FAILURE",
  "STRING_BUILDER_INVALID_PTR",
  "STRING_BUILDER_STRCAT_ERR"
};
 ...
 * @return {char*} A character array of the built string
 */
